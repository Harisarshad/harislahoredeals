...
class OrderItemWidget extends StatelessWidget {
  ...
  const OrderItemWidget({Key? key, this.currency, this.product})
      : super(key: key);
                                ...
                                children: <Widget>[
                                  Text(
                                    '- ' +
                                        ...
                                        ' ( $currency${product['variation']['price']} )',
                                    overflow: TextOverflow.ellipsis,
                                    maxLines: 2,
                        ...
                        product['options'].length == 0
                            ...
                            : Column(
                                children: List.generate(
                                    product['options'].length, (index) {
                                  return Text(
                                    '-- ' +
                                        product['options'][index]['name'] +
                                        ' ( $currency${product['options'][index]['price']} )',
                                    overflow: TextOverflow.ellipsis,
                                    maxLines: 2,
                                    style: Theme.of(context).textTheme.caption,
                                  );
